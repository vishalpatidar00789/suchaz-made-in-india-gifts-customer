                        ...
                        <Slider
                            ...
                            <div className="ps-block--testimonial">
                                <div className="ps-block__header">
                                    <img src="/static/img/users/1.jpg" alt="MadeInIndiaGifts" />
                                </div>
                            ...
                            <div className="ps-block--testimonial">
                                <div className="ps-block__header">
                                    <img src="/static/img/users/2.png" alt="MadeInIndiaGifts" />
                                </div>
                                <div className="ps-block__content">
                                    <i className="icon-quote-close"></i>
                                    <h4>
                            ...
                            <div className="ps-block--testimonial">
                                <div className="ps-block__header">
                                    <img src="/static/img/users/3.jpg" alt="MadeInIndiaGifts" />
                                </div>
                                <div className="ps-block__content">
                                    <i className="icon-quote-close"></i>
                                    <h4>

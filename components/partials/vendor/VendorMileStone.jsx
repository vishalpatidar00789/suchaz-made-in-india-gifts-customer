            ...
            <div className="ps-section__content">
                <div className="ps-block--vendor-milestone">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-1.png" alt="MadeInIndiaGifts.in" />
                    </div>
                ...
                <div className="ps-block--vendor-milestone reverse">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-2.png" alt="MadeInIndiaGifts.in" />
                    </div>
                    <div className="ps-block__number">
                        <span>2</span>
                    </div>
                ...
                <div className="ps-block--vendor-milestone">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-3.png" alt="MadeInIndiaGifts.in" />
                    </div>
                    <div className="ps-block__number">
                        <span>3</span>
                    </div>
                ...
                <div className="ps-block--vendor-milestone reverse">
                    ...
                    <div className="ps-block__right">
                        <img src="/static/img/vendor/milestone-4.png" alt="MadeInIndiaGifts.in" />
                    </div>
                    <div className="ps-block__number">
                        <span>4</span>
                    </div>

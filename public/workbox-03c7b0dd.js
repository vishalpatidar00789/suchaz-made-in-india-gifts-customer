define("./workbox-03c7b0dd.js",['exports'], function (exports) { 'use strict';
    ...
    */
    ...
    async function executeQuotaErrorCallbacks() {
      {
        logger.log(`About to run ${quotaErrorCallbacks$1.size} ` + `callbacks to clean up caches.`);
      }
    ...
    */
    ...
    class StaleWhileRevalidate {
      ...
      async handle({
        ...
        {
          logger.groupCollapsed(messages$2.strategyStart('StaleWhileRevalidate', request));
    ...
    */
    ...
    class CacheFirst {
      ...
      async handle({
        ...
        {
          logger.groupCollapsed(messages$2.strategyStart('CacheFirst', request));
    ...
    */
    ...
    class NetworkFirst {
      ...
      async handle({
        ...
        {
          logger.groupCollapsed(messages$2.strategyStart('NetworkFirst', request));
...
//# sourceMappingURL=workbox-03c7b0dd.js.map

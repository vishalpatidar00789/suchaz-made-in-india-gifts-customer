...
import { SinglePageWrapper, TACPageSection, TACSectionContent } from 'assets/styles/page.style';
...
const TermsAndConditionsPage: Page = () => (
    <SinglePageWrapper>
            ...
            <div className="container">
                ...
                <TACSectionContent>
                    ...
                    <p>
                        ...
                        terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                    ...
                    <p>
                        ...
                        's Privacy Policy. Most interactive websites use cookies to let us retrieve the user’s details
                    ...
                    <p>
                        ...
                         does not filter, edit, publish or review Comments prior to their presence on the website.
                        Comments do not reflect the views and opinions of{' '}
                        <a href={siteurl} target="_blank">
                            madeinindiagifts.in
                        </a>
                        ,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                    ...
                    <p>
                        ...
                         a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            and (c) fits within the context of the linking party’s site. We may consider and approve
                            other link requests from the following types of organizations:
                        </li>
                    ...
                    <p>
                        ...
                        and its products or services; and (c) fits within the context of the linking party’s site. If
                        you are one of the organizations listed in paragraph 2 above and are interested in linking to
...
TermsAndConditionsPage.Layout = MainLayout;
